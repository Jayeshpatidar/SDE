...
function Hero() {
  return (
    <section
      id="hero"
      className="pb-28 pt-24 sm:pt-28 md:pt-28  flex px-6 lg:px-24"
    >
      <div className="self-center">
        <div className="hs-tooltip [--placement:right] w-20 hs-tooltip-toggle">
          <img
            src={user_info.main.photo}
            className="rounded-full mb-6 lg:hidden w-[80px] h-[80px]"
            alt="Jayesh Patidar"
          />
        </div>
        <div className="flex gap-2 align-center flex-wrap md:flex-nowrap">
          <div className="lg:w-[80%] text-zinc-900 dark:text-zinc-100 self-center">
            ...
            <h1 className="font-black mt-3 text-5xl lg:w-[85%]">
              Jayesh <span className="text-[#991b1b]">Patidar</span>
            </h1>
            ...
            <div className="flex gap-2 mt-6">
              <a
                href="#projects"
                className="px-6 py-3 border text-red-800 border-red-800 rounded hover:bg-red-800 hover:text-white hover:border-red-800 dark:border-white font-medium transition-all duration-300"
              >
                Projects
              </a>
              <a
