...
function Project({ title, description, technologies, link, github }) {
  return (
    <div className="border border-gray-100 hover:bg-zinc-100 hover:dark:bg-zinc-900 transition-all duration-300 p-6 md:rounded-xl flex flex-col justify-between">
      {/* =========== PROJECT TITLE =========== */}
      <div>
